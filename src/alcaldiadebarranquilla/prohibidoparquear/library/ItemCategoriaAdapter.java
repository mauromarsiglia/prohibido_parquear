...
public class ItemCategoriaAdapter extends BaseAdapter {
	...
	public ItemCategoriaAdapter(Activity activity, ArrayList<Categoria> items){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    int imageResource = activity.getResources().getIdentifier("@drawable/ic_launcher", null, activity.getPackageName());
